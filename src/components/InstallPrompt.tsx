...
export const InstallPrompt = () => {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[60] w-[min(100vw-1.5rem,22rem)] rounded-2xl border border-border bg-gradient-card shadow-elegant p-3 flex items-center gap-3 animate-fade-in">
